...
RSpec.describe BooksController, type: :controller do
  ...
  describe 'action' do
    ...
    context '#return' do
      ...
      it 'is expected not to change `return_date` in last history record by if book`s state is already true',
         :not_signed_in_user do
        expect {
          book.state = true
          return_query
        }.to_not change { book.histories.last.return_date }
  ...
  describe 'strong params' do
    ...
    it { is_expected.to permit(:name, :description, :author, :avatar).for(:create, params: params_hash) }
  end
end
